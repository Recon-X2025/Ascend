...
export default async function CompanySalariesPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <div className="page-container py-6">
      ...
      <ReviewsTab companyId={company.id} companySlug={company.slug} initialSubTab="salaries" />
    </div>
  );
}
