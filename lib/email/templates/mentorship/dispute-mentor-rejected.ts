...
export async function sendDisputeMentorRejected(params: {
  to: string;
  mentorName: string;
  amountRupees: string;
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;color:#16A34A;">Dispute resolved — payment released</h1>
  <p>Hi ${mentorName},</p>
  <p>The mentee's dispute was not upheld. ₹${amountRupees} has been released to your account.</p>
