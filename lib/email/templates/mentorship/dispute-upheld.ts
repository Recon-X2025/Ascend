...
export async function sendDisputeUpheld(params: {
  to: string;
  menteeName: string;
  amountRupees: string;
  ...
  await resend.emails.send({
    from: FROM,
    to: [to],
    subject: `Dispute upheld — refund issued — ${APP_NAME}`,
    html: `
<!DOCTYPE html>
<html>
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;color:#16A34A;">Dispute upheld</h1>
  <p>Hi ${menteeName},</p>
  <p>Your dispute has been upheld. A refund of ₹${amountRupees} will be processed to your original payment method.</p>
