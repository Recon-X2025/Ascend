...
export async function sendSessionReminder(params: {
  ...
  await client.emails.send({
    from: FROM,
    to: [to],
    subject: `Session ${sessionNumber} tomorrow — ${APP_NAME}`,
    html: `
<!DOCTYPE html>
<html>
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;color:#16A34A;">Session ${sessionNumber} reminder</h1>
  <p>Hi ${recipientName},</p>
  <p>This is a reminder that Session ${sessionNumber} is scheduled for <strong>${dateStr}</strong>.</p>
