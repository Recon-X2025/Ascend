...
export async function sendDisputeEvidenceAssembled(params: {
  to: string;
  menteeName: string;
  disputeUrl: string;
}) {
  ...
  await resend.emails.send({
    from: FROM,
    to: [to],
    subject: `Dispute update — evidence gathered — ${APP_NAME}`,
    html: `
<!DOCTYPE html>
<html>
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;">Evidence gathered</h1>
  <p>Hi ${menteeName},</p>
  <p>We've assembled the evidence for your dispute. Resolution will follow shortly.</p>
