...
export async function sendGoalDocumentCreated(params: {
  to: string;
  menteeName: string;
  documentUrl: string;
}) {
  ...
  await client.emails.send({
    from: FROM,
    to: [to],
    subject: `Goal document ready for your review — ${APP_NAME}`,
    html: `
<!DOCTYPE html>
<html>
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;color:#16A34A;">Goal document ready</h1>
  <p>Hi ${menteeName},</p>
  <p>Your mentor has created the engagement goal document. Please review and sign when ready.</p>
