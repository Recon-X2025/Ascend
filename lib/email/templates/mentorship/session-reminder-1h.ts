...
export async function sendSessionReminder1h(params: {
  to: string;
  ...
  await client.emails.send({
    from: FROM,
    to: [to],
    subject: `Session ${sessionNumber} in 1 hour — ${APP_NAME}`,
    html: `
<!DOCTYPE html>
<html>
...
<body style="font-family:system-ui,-apple-system,sans-serif;line-height:1.6;color:#333;max-width:480px;margin:0 auto;padding:24px;">
  ...
  <h1 style="font-size:20px;color:#16A34A;">Session ${sessionNumber} starting soon</h1>
  <p>Hi ${recipientName},</p>
  <p>Session ${sessionNumber} starts at <strong>${dateStr}</strong>.</p>
  <p><a href="${joinUrl}" style="color:#16A34A;">Join now</a> | <a href="${engagementUrl}">View engagement</a></p>
